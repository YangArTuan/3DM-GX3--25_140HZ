...
class InertialModels(object):
    ...
    node_3dm_gq7 = _mscl.InertialModels_node_3dm_gq7
...
class RTKModels(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    node_3dm_rtk = _mscl.RTKModels_node_3dm_rtk

    def __init__(self):
        _mscl.RTKModels_swiginit(self, _mscl.new_RTKModels())
    __swig_destroy__ = _mscl.delete_RTKModels

# Register RTKModels in _mscl:
_mscl.RTKModels_swigregister(RTKModels)
...
class MipTypes(object):
    ...
    CMD_PPS_OUTPUT = _mscl.MipTypes_CMD_PPS_OUTPUT
    ...
    CMD_EF_KINEMATIC_CONSTRAINT = _mscl.MipTypes_CMD_EF_KINEMATIC_CONSTRAINT
    ...
    CH_FIELD_GNSS_IONOSPHERIC_CORRECTION = _mscl.MipTypes_CH_FIELD_GNSS_IONOSPHERIC_CORRECTION
    ...
    CH_FIELD_GNSS_1_IONOSPHERIC_CORRECTION = _mscl.MipTypes_CH_FIELD_GNSS_1_IONOSPHERIC_CORRECTION
    ...
    CH_FIELD_GNSS_2_IONOSPHERIC_CORRECTION = _mscl.MipTypes_CH_FIELD_GNSS_2_IONOSPHERIC_CORRECTION
    ...
    CH_FIELD_GNSS_3_IONOSPHERIC_CORRECTION = _mscl.MipTypes_CH_FIELD_GNSS_3_IONOSPHERIC_CORRECTION
    ...
    CH_FIELD_GNSS_4_IONOSPHERIC_CORRECTION = _mscl.MipTypes_CH_FIELD_GNSS_4_IONOSPHERIC_CORRECTION
    ...
    CH_FIELD_GNSS_5_IONOSPHERIC_CORRECTION = _mscl.MipTypes_CH_FIELD_GNSS_5_IONOSPHERIC_CORRECTION
    ...
    CH_DATA_RECEIVED_EPOCH = _mscl.MipTypes_CH_DATA_RECEIVED_EPOCH
...
class InertialTypes(object):
    ...
    FIXTYPE_FTK_FIXED = _mscl.InertialTypes_FIXTYPE_FTK_FIXED
    ...
    CONSTRAINT_NONE = _mscl.InertialTypes_CONSTRAINT_NONE
    CONSTRAINT_ZERO_MAGNITUDE = _mscl.InertialTypes_CONSTRAINT_ZERO_MAGNITUDE
    CONSTRAINT_WHEELED_VEHICLE = _mscl.InertialTypes_CONSTRAINT_WHEELED_VEHICLE
    ...
    PPS_OUTPUT_DISABLED = _mscl.InertialTypes_PPS_OUTPUT_DISABLED
    PPS_INPUT_RECEIVER_1 = _mscl.InertialTypes_PPS_INPUT_RECEIVER_1
    PPS_INPUT_RECEIVER_2 = _mscl.InertialTypes_PPS_INPUT_RECEIVER_2
    PPS_SOURCE_GENERATED = _mscl.InertialTypes_PPS_SOURCE_GENERATED
    PPS_IO_GPIO_1 = _mscl.InertialTypes_PPS_IO_GPIO_1
    PPS_IO_GPIO_2 = _mscl.InertialTypes_PPS_IO_GPIO_2
    PPS_IO_GPIO_3 = _mscl.InertialTypes_PPS_IO_GPIO_3
    PPS_IO_GPIO_4 = _mscl.InertialTypes_PPS_IO_GPIO_4
...
class KinematicConstraints(object):
    ...
    def __init__(self, *args):
        _mscl.KinematicConstraints_swiginit(self, _mscl.new_KinematicConstraints(*args))
    acceleration = property(_mscl.KinematicConstraints_acceleration_get, _mscl.KinematicConstraints_acceleration_set)
    velocity = property(_mscl.KinematicConstraints_velocity_get, _mscl.KinematicConstraints_velocity_set)
    angularRate = property(_mscl.KinematicConstraints_angularRate_get, _mscl.KinematicConstraints_angularRate_set)
    __swig_destroy__ = _mscl.delete_KinematicConstraints

# Register KinematicConstraints in _mscl:
_mscl.KinematicConstraints_swigregister(KinematicConstraints)
...
class RTKDeviceStatusFlags(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr

    def __init__(self, *args):
        _mscl.RTKDeviceStatusFlags_swiginit(self, _mscl.new_RTKDeviceStatusFlags(*args))
    modemEnabled = property(_mscl.RTKDeviceStatusFlags_modemEnabled_get, _mscl.RTKDeviceStatusFlags_modemEnabled_set)
    modemConnected = property(_mscl.RTKDeviceStatusFlags_modemConnected_get, _mscl.RTKDeviceStatusFlags_modemConnected_set)
    clientConnected = property(_mscl.RTKDeviceStatusFlags_clientConnected_get, _mscl.RTKDeviceStatusFlags_clientConnected_set)
...
class MipNodeFeatures(object):
    ...
    def supportedAccelerationConstraintOptions(self):
        return _mscl.MipNodeFeatures_supportedAccelerationConstraintOptions(self)

    def supportedVelocityConstraintOptions(self):
        return _mscl.MipNodeFeatures_supportedVelocityConstraintOptions(self)

    def supportedAngularConstraintOptions(self):
        return _mscl.MipNodeFeatures_supportedAngularConstraintOptions(self)

    def supportedPpsSourceOptions(self):
        return _mscl.MipNodeFeatures_supportedPpsSourceOptions(self)

    def supportedPpsOutputOptions(self):
        return _mscl.MipNodeFeatures_supportedPpsOutputOptions(self)
...
class InertialNode(object):
    ...
    def saveSettingsAsStartup(self, *args):
        return _mscl.InertialNode_saveSettingsAsStartup(self, *args)
    ...
    def getKinematicConstraints(self):
        return _mscl.InertialNode_getKinematicConstraints(self)

    def setKinematicConstraints(self, constraintOptions):
        return _mscl.InertialNode_setKinematicConstraints(self, constraintOptions)
    ...
    def getPpsOutput(self):
        return _mscl.InertialNode_getPpsOutput(self)

    def setPpsOutput(self, ppsOutput):
        return _mscl.InertialNode_setPpsOutput(self, ppsOutput)
...
class RTKNode(object):
    ...
    def doCommand(self, descriptorSet, cmdDescriptor, fieldData, ackNackResponse, dataResponse, responseDataDescriptor=0):
        return _mscl.RTKNode_doCommand(self, descriptorSet, cmdDescriptor, fieldData, ackNackResponse, dataResponse, responseDataDescriptor)

    @staticmethod
    def deviceName(serial):
        return _mscl.RTKNode_deviceName(serial)

    def connection(self):
        return _mscl.RTKNode_connection(self)

    def features(self):
        return _mscl.RTKNode_features(self)

    def lastCommunicationTime(self):
        return _mscl.RTKNode_lastCommunicationTime(self)

    def lastDeviceState(self):
        return _mscl.RTKNode_lastDeviceState(self)

    def firmwareVersion(self):
        return _mscl.RTKNode_firmwareVersion(self)

    def model(self):
        return _mscl.RTKNode_model(self)

    def modelName(self):
        return _mscl.RTKNode_modelName(self)

    def modelNumber(self):
        return _mscl.RTKNode_modelNumber(self)

    def serialNumber(self):
        return _mscl.RTKNode_serialNumber(self)

    def lotNumber(self):
        return _mscl.RTKNode_lotNumber(self)

    def deviceOptions(self):
        return _mscl.RTKNode_deviceOptions(self)

    def getDataPackets(self, timeout=0, maxPackets=0):
        return _mscl.RTKNode_getDataPackets(self, timeout, maxPackets)

    def totalPackets(self):
        return _mscl.RTKNode_totalPackets(self)

    def timeout(self, *args):
        return _mscl.RTKNode_timeout(self, *args)

    def name(self):
        return _mscl.RTKNode_name(self)

    def ping(self):
        return _mscl.RTKNode_ping(self)

    def setToIdle(self):
        return _mscl.RTKNode_setToIdle(self)

    def cyclePower(self):
        return _mscl.RTKNode_cyclePower(self)

    def resume(self):
        return _mscl.RTKNode_resume(self)
...
class KinematicConstraintOptions(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr

    def iterator(self):
        return _mscl.KinematicConstraintOptions_iterator(self)
    def __iter__(self):
        return self.iterator()

    def __nonzero__(self):
        return _mscl.KinematicConstraintOptions___nonzero__(self)

    def __bool__(self):
        return _mscl.KinematicConstraintOptions___bool__(self)

    def __len__(self):
        return _mscl.KinematicConstraintOptions___len__(self)

    def __getslice__(self, i, j):
        return _mscl.KinematicConstraintOptions___getslice__(self, i, j)

    def __setslice__(self, *args):
        return _mscl.KinematicConstraintOptions___setslice__(self, *args)

    def __delslice__(self, i, j):
        return _mscl.KinematicConstraintOptions___delslice__(self, i, j)

    def __delitem__(self, *args):
        return _mscl.KinematicConstraintOptions___delitem__(self, *args)

    def __getitem__(self, *args):
        return _mscl.KinematicConstraintOptions___getitem__(self, *args)

    def __setitem__(self, *args):
        return _mscl.KinematicConstraintOptions___setitem__(self, *args)

    def pop(self):
        return _mscl.KinematicConstraintOptions_pop(self)

    def append(self, x):
        return _mscl.KinematicConstraintOptions_append(self, x)

    def empty(self):
        return _mscl.KinematicConstraintOptions_empty(self)

    def size(self):
        return _mscl.KinematicConstraintOptions_size(self)

    def swap(self, v):
        return _mscl.KinematicConstraintOptions_swap(self, v)

    def begin(self):
        return _mscl.KinematicConstraintOptions_begin(self)

    def end(self):
        return _mscl.KinematicConstraintOptions_end(self)

    def rbegin(self):
        return _mscl.KinematicConstraintOptions_rbegin(self)

    def rend(self):
        return _mscl.KinematicConstraintOptions_rend(self)

    def clear(self):
        return _mscl.KinematicConstraintOptions_clear(self)

    def get_allocator(self):
        return _mscl.KinematicConstraintOptions_get_allocator(self)

    def pop_back(self):
        return _mscl.KinematicConstraintOptions_pop_back(self)

    def erase(self, *args):
        return _mscl.KinematicConstraintOptions_erase(self, *args)

    def __init__(self, *args):
        _mscl.KinematicConstraintOptions_swiginit(self, _mscl.new_KinematicConstraintOptions(*args))

    def push_back(self, x):
        return _mscl.KinematicConstraintOptions_push_back(self, x)

    def front(self):
        return _mscl.KinematicConstraintOptions_front(self)

    def back(self):
        return _mscl.KinematicConstraintOptions_back(self)

    def assign(self, n, x):
        return _mscl.KinematicConstraintOptions_assign(self, n, x)

    def resize(self, *args):
        return _mscl.KinematicConstraintOptions_resize(self, *args)

    def insert(self, *args):
        return _mscl.KinematicConstraintOptions_insert(self, *args)

    def reserve(self, n):
        return _mscl.KinematicConstraintOptions_reserve(self, n)

    def capacity(self):
        return _mscl.KinematicConstraintOptions_capacity(self)
    __swig_destroy__ = _mscl.delete_KinematicConstraintOptions

# Register KinematicConstraintOptions in _mscl:
_mscl.KinematicConstraintOptions_swigregister(KinematicConstraintOptions)
...
class PpsInputOutputOptions(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr

    def iterator(self):
        return _mscl.PpsInputOutputOptions_iterator(self)
    def __iter__(self):
        return self.iterator()

    def __nonzero__(self):
        return _mscl.PpsInputOutputOptions___nonzero__(self)

    def __bool__(self):
        return _mscl.PpsInputOutputOptions___bool__(self)

    def __len__(self):
        return _mscl.PpsInputOutputOptions___len__(self)

    def __getslice__(self, i, j):
        return _mscl.PpsInputOutputOptions___getslice__(self, i, j)

    def __setslice__(self, *args):
        return _mscl.PpsInputOutputOptions___setslice__(self, *args)

    def __delslice__(self, i, j):
        return _mscl.PpsInputOutputOptions___delslice__(self, i, j)

    def __delitem__(self, *args):
        return _mscl.PpsInputOutputOptions___delitem__(self, *args)

    def __getitem__(self, *args):
        return _mscl.PpsInputOutputOptions___getitem__(self, *args)

    def __setitem__(self, *args):
        return _mscl.PpsInputOutputOptions___setitem__(self, *args)

    def pop(self):
        return _mscl.PpsInputOutputOptions_pop(self)

    def append(self, x):
        return _mscl.PpsInputOutputOptions_append(self, x)

    def empty(self):
        return _mscl.PpsInputOutputOptions_empty(self)

    def size(self):
        return _mscl.PpsInputOutputOptions_size(self)

    def swap(self, v):
        return _mscl.PpsInputOutputOptions_swap(self, v)

    def begin(self):
        return _mscl.PpsInputOutputOptions_begin(self)

    def end(self):
        return _mscl.PpsInputOutputOptions_end(self)

    def rbegin(self):
        return _mscl.PpsInputOutputOptions_rbegin(self)

    def rend(self):
        return _mscl.PpsInputOutputOptions_rend(self)

    def clear(self):
        return _mscl.PpsInputOutputOptions_clear(self)

    def get_allocator(self):
        return _mscl.PpsInputOutputOptions_get_allocator(self)

    def pop_back(self):
        return _mscl.PpsInputOutputOptions_pop_back(self)

    def erase(self, *args):
        return _mscl.PpsInputOutputOptions_erase(self, *args)

    def __init__(self, *args):
        _mscl.PpsInputOutputOptions_swiginit(self, _mscl.new_PpsInputOutputOptions(*args))

    def push_back(self, x):
        return _mscl.PpsInputOutputOptions_push_back(self, x)

    def front(self):
        return _mscl.PpsInputOutputOptions_front(self)

    def back(self):
        return _mscl.PpsInputOutputOptions_back(self)

    def assign(self, n, x):
        return _mscl.PpsInputOutputOptions_assign(self, n, x)

    def resize(self, *args):
        return _mscl.PpsInputOutputOptions_resize(self, *args)

    def insert(self, *args):
        return _mscl.PpsInputOutputOptions_insert(self, *args)

    def reserve(self, n):
        return _mscl.PpsInputOutputOptions_reserve(self, n)

    def capacity(self):
        return _mscl.PpsInputOutputOptions_capacity(self)
    __swig_destroy__ = _mscl.delete_PpsInputOutputOptions

# Register PpsInputOutputOptions in _mscl:
_mscl.PpsInputOutputOptions_swigregister(PpsInputOutputOptions)
