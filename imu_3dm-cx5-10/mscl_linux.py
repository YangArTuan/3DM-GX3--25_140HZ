...
class RTKDeviceStatusFlags(Bitfield):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    STATE = _mscl.RTKDeviceStatusFlags_STATE
    STATUS_CODE = _mscl.RTKDeviceStatusFlags_STATUS_CODE
    RESET_REASON = _mscl.RTKDeviceStatusFlags_RESET_REASON
    MODEM_POWERED = _mscl.RTKDeviceStatusFlags_MODEM_POWERED
    CELL_CONNECTED = _mscl.RTKDeviceStatusFlags_CELL_CONNECTED
    SERVER_CONNECTED = _mscl.RTKDeviceStatusFlags_SERVER_CONNECTED
    DATA_ENABLED = _mscl.RTKDeviceStatusFlags_DATA_ENABLED
    POWER_ON = _mscl.RTKDeviceStatusFlags_POWER_ON
    HARDWARE_RESET = _mscl.RTKDeviceStatusFlags_HARDWARE_RESET
    SOFT_RESET = _mscl.RTKDeviceStatusFlags_SOFT_RESET
    WATCHDOG_RESET = _mscl.RTKDeviceStatusFlags_WATCHDOG_RESET

    def __init__(self, *args):
        _mscl.RTKDeviceStatusFlags_swiginit(self, _mscl.new_RTKDeviceStatusFlags(*args))

    def state(self, *args):
        return _mscl.RTKDeviceStatusFlags_state(self, *args)

    def statusCode(self, *args):
        return _mscl.RTKDeviceStatusFlags_statusCode(self, *args)

    def resetReason(self, *args):
        return _mscl.RTKDeviceStatusFlags_resetReason(self, *args)

    def modemPowered(self, *args):
        return _mscl.RTKDeviceStatusFlags_modemPowered(self, *args)

    def cellConnected(self, *args):
        return _mscl.RTKDeviceStatusFlags_cellConnected(self, *args)

    def serverConnected(self, *args):
        return _mscl.RTKDeviceStatusFlags_serverConnected(self, *args)

    def dataEnabled(self, *args):
        return _mscl.RTKDeviceStatusFlags_dataEnabled(self, *args)
...
class PositionReferenceConfiguration(object):
    ...
    def source(self):
        return _mscl.PositionReferenceConfiguration_source(self)

    @staticmethod
    def fromResponseData(resData):
        return _mscl.PositionReferenceConfiguration_fromResponseData(resData)
...
def PositionReferenceConfiguration_fromResponseData(resData):
    return _mscl.PositionReferenceConfiguration_fromResponseData(resData)
...
class OdometerConfiguration(object):
    ...
    mode = property(_mscl.OdometerConfiguration_mode_get, _mscl.OdometerConfiguration_mode_set)
